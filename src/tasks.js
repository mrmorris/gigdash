...
new Task(
    1,
    "I haven't had a banana split in years! my favorite character Cindy ate one on 'Sunrise Bay' right before she was murdered by her cousin's uncle in yesterday's episode. it made me very sad. maybe this will cheer me up... ",
    "Judy",
  ...
  ,new Task(
    2,
    "mommy says my mouth smells like trash and that i need to brush my teeth with real tuthpaste",
    "Timmy",
  ...
  ,new Task(
    3,
    "please help me i do not feel well and i hope that foodtown's medicine can help",
    "Priscilla Pimberton",
    C.NEIGHBORHOOD_OLNEYVILLE,
    [C.ITEM_MEDICINE],
  ...
  ,new Task(
    4,
    "It's pizza time. Get here quick or get lost, loser.",
    "Peter Pasquale",
    C.NEIGHBORHOOD_FOX_POINT,
  ...
  ,new Task(
    5,
    "Boy, if I don't get some of those new-age eye drops, I might just drop dead where I stand. Now get ye to the store.",
  ...
  ,new Task(
    6,
    "Ever humped face first into the city's protected pool in nothing but your meat suit? That's me after plugging in 48 with my fellow socket rockers. I need to rest and recharge. Load me up, Miles.",
    "Bright Eyes",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    7,
    "Good evening Miles. A friend of my employer has come down with a terrible case of knows too much. I'm sending a couple items to help put him out of his misery. I'll be looking out for your arrival.",
    "Mr. Nobody",
    C.NEIGHBORHOOD_FOX_POINT,
  ...
  ,new Task(
    8,
    "They tell me the dust storm is coming. First one to hit Neo Brooklyn in years, and no one is prepared. Where will you be when the dust blows in?",
    "Carl Weatherford",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    9,
    "New Year, new me, right? But the prosthetic interchange has done a number on my taste buds. Can my favorite Miles get me something sweet?",
    "Oneka Ashleigh",
  ...
  ,new Task(
    10,
    "Corporate is raving about your numbers, but I don't buy it. It's time for a suprise order review. Can you handle this on top of your other orders?",
    "Admin007",
    C.NEIGHBORHOOD_FOX_POINT,
  ...
  ,new Task(
    11,
    "Looking a little complacent. Time to see if you're really going the Extra Mile.",
    "Admin003",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    12,
    "Neo Brooklyn Bridge is finally opening after the last lockdown. That means it's safe to hit the trails! It's about time too. All the rumors of that MOTHMAN are finally winding down.",
    "Garhett Gunner",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    13,
    "One night outside the city isn't enough. Two day camping trip should be enough time build a big camp fire and really get a chance to enjoy the wildlife. And say hello to new friends.",
    "Garhett Gunner",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    14,
    "What's crazy is how no one believes ME. But that's okay. You believe me, don't you Miles? Or you will once I come back with my new friend.",
    "Garhett Gunner",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    15,
    "UGH my mother locker herself in the game room again and somebody stole my last crowbar. I need to bust her out so can you grab me a new one from Do It Best?",
    "Shelby Sparks",
    C.NEIGHBORHOOD_OLNEYVILLE,
    [C.ITEM_CROWBAR],
  ...
  ,new Task(
    16,
    "Hi \"Miles\"! (lol) Just wanted to pop in to give you some business, sweetie. But actually, we are out of toothpaste anyway. Love you!",
    "Mom",
    C.NEIGHBORHOOD_OLNEYVILLE,
    [C.ITEM_TOOTHPASTE],
  ...
  ,new Task(
    17,
    "IM SORRY IN ADVANCE MY PHONE GOT STUCK ON CAPS LOCK AND I DONT KNOW HOW TO REMOVE IT CAN U GET THESE THINGS 4 ME TY",
    "Eugenia Delphor",
    C.NEIGHBORHOOD_FOX_POINT,
  ...
  ,new Task(
    18,
    "Hi there I've got a little experiment I need some supplies for. Think you can help in a timely fashion?",
    "Dr. Borkian",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    19,
    "I can't believe they let you put any name into this thing! How crazy is that? My grandma's Metaverse account has better cybersecurity measures. Anyway, I'm just testing ExtraMiles out. This one should be easy for you.",
    "Adama Starfrakker",
    C.NEIGHBORHOOD_FOX_POINT,
    [C.ITEM_SHOVEL],
    "Nice work.",
  ...
  ,new Task(
    20,
    "Hey bud! We're having a party tonight which you should totally come to but obviously we also need you to actually grab all of the stuff. Think you can swing it in a timely fashion? We want to get started sooner rather than later.",
    "Jacoby Jahoomes",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    21,
    "Hello I am an old woman who is definitely old and I just ran out of medicine but also alcohol. Can you please get these things and leave them at the door. No need for me to sign anything on the tablet or anything. I have a terrible cough. Don't want to get you sick.",
    "Ruth Oldperson",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    22,
    "hiii sweetie! \"Miles\" can you just grab me some essentials. thanks so much love mom",
    "Mom",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    23,
    "how ya doin kid? get these things for your Uncle Tony and maybe there'll be something special in it for ya",
    "Tony Lazuto",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    24,
    "Howdy, Miles. I'm looking to grill up something delicious and sit outside with a few cold ones. If you have any free time, care to join a pal?",
    "Simple Rick",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    26,
    "got a big race coming up buddy boy and i need to boost my energy levels and get my treadmill squeaky clean. can you run around town and get these essentials for me?",
    "Philip Cross",
    C.NEIGHBORHOOD_OLNEYVILLE,
  ...
  ,new Task(
    27,
    "Miles! i want to have a few martinis with a friend. can you grab me everything I need? should be an easy one! thanks so much",
    "Summer Francesca",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    28,
    "Miles! i'm running low on adult beverages and you seem like the perfect one to help fix that. can you grab me a few from Foodtown?",
    "Summer Francesca",
    C.NEIGHBORHOOD_FEDERAL_HILL,
  ...
  ,new Task(
    29,
    "hey Miles! Summer here! sorry to bug you again but I'm REALLY hankering for a smoothie all of a sudden. Can you grab me a few bananas and other stuff?",
    "Summer Francesca",
    C.NEIGHBORHOOD_FEDERAL_HILL,
